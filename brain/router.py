...
async def handle_command(text: str) -> str:
    ...
    commands = {
        ...
        "help": (
            ...
            "/content_run — إنتاج ومونتاج شورتس فيروزي فوري وإرسال المعاينة هنا\n"
            "/content_batch — تجهيز هرم المحتوى الأسبوعي (2 وثائقي طويل + 7 شورتس)\n"
            "/documentary — إنتاج فيلم وثائقي طويل بنظام 3D Mannequin المفرغ\n"
            "/content_status — تقرير حالة مهام المحتوى ونسب الاحتفاظ (Supabase)\n"
            "\nأو ابعتلي أي فكرة أو رسالة عادية وهرد عليك فوراً! 🧠"
        ),
        "status": "✅ النظام شغال\n🧠 AI: Gemini (مع fallback تلقائي)\n💾 الذاكرة: Supabase",
        "content": (
            "🎬 *موديول إنتاج المحتوى (Content Orchestrator)*\n\n"
            "النظام مجهز بالكامل لإنتاج شورتس يوتيوب والوثائقيات وبوستات السوشيال ميديا.\n"
            "الأوامر:\n"
            "• `/content_run` : إنتاج فيديو فوري بكرت RTX 4070 وإرساله هنا\n"
            "• `/content_batch` : تجهيز خطة الأسبوع بالكامل مع الأغلفة الصادمة\n"
            "• `/documentary` : توليد وثائقي استقصائي كامل بنظام 3D Mannequin\n"
            "• `/content_status` : إحصائيات الأداء ونسب الـ Retention\n"
        ),
    }
